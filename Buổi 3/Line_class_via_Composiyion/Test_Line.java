package Line_class_via_Composiyion;
import java.awt.*;
...
public class Test_Line {
    public static void main(String[] args){
        ...
        System.out.println("begin's x and y are:" + Arrays.toString(11.getBeginXY()));
        System.out.println("end's x and y are:" + Arrays.toString(11.getEndXY()));
